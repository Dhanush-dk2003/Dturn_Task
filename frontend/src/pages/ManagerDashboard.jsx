...
const [statusFilter, setStatusFilter] = useState('');
  ...
  const fetchProjects = async () => {
    ...
    const filteredProjects = projects.filter(p => p.name.toLowerCase().includes(searchTerm.toLowerCase())); // add filter if needed
  ...
  return (
    <div className="d-flex">
      ...
      <div
        ...
        style={{ width: "200px" }}
      ></div>
      <div className="flex-grow-1" style={{ marginLeft: "80px",marginRight:'50px' }}>
